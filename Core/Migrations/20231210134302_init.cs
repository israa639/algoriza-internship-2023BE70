        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    requestsNum = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ArabicName", "Name", "requestsNum" },
                values: new object[,]
                {
                    { 1, "قلب", "cardiology", 0 },
                    { 2, "جراحة", "Surgery", 0 },
                    { 3, "نفسية", "Psychiatry", 0 },
                    { 4, "مناعة", "Immunology", 0 },
                    { 5, "جراحة مخ", "brain surgery", 0 },
                    { 7, "مخ واعصاب", "Brain ", 0 },
                    { 9, "جلدية", "Dermatology", 0 }
                });
